...
<head>
    ...
    <title>{{ __('StudyMe') }}</title>
    <link rel="icon" type="image/x-icon" href="{{asset('assets/logos/studyme.png')}}">
    ...
    <div class="container px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
            <div class="flex items-center flex-col w-full px-6">
                <img src="{{asset('assets/logos/studyme.png')}}" alt=""
                     class="h-24 w-auto text-gray-700 sm:px-6 sm:h-24 mt-4">
                <h1 class="text-3xl font-medium leading-tight mt-0 mb-2 text-black-600 sm:text-5xl">StudyMe</h1>
                <p class="leading-normal text-2xl mb-4 text-white-100 justify-center">An one platform for your all study
                    materials and links
