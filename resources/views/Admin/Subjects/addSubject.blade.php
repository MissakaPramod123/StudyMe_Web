<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight"> //class font-semibold text-xl text-gray-800
            {{ __('Add Subjects') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <table class="min-w-full">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-left">
                                <b>Subject Name</b> //Subject Name is taken to create the Subject folder
                            </th>
                        </tr>
                        </thead>
                        <tbody>
